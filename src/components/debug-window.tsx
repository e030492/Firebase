...
export function DebugWindow() {
  const { status, error, users, clients, systems, equipments, protocols, cedulas, statusMessage } = useData();
  ...
  return (
    <Card className="fixed bottom-4 right-4 z-50 w-80 shadow-2xl bg-background/80 backdrop-blur-sm">
        ...
        <CardContent className="text-xs p-3 pt-0">
             ...
             {statusMessage && <p className="mb-2 text-muted-foreground break-words">{statusMessage}</p>}
