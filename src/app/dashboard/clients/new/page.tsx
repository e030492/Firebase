                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    {(almacenes[0].planosUrl || []).map((url, i) => (
                      <div key={i} className="relative group border rounded-md p-2">
                        ...
                        <Button type="button" variant="ghost" size="icon" className="absolute top-0 right-0 h-6 w-6" onClick={() => removePlano(0, i)} disabled={loading}>
                   ...
                   <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    {(almacenes[1].planosUrl || []).map((url, i) => (
                      <div key={i} className="relative group border rounded-md p-2">
                        ...
                        <Button type="button" variant="ghost" size="icon" className="absolute top-0 right-0 h-6 w-6" onClick={() => removePlano(1, i)} disabled={loading}>
                          <Trash2 className="h-4 w-4 text-destructive" />
                        </Button>
                      </div>
                    ))}
